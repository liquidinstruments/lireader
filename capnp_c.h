...
/*
 * Must align data, len and cap to 8 byte boundaries in 32-bit builds?
 *     -- Liquid Instruments
 */

#ifdef __GNUC__ /* GCC or Clang */
#define LI_C_CAPNP_ALIGN __attribute__((__aligned__(8)))
#else
#define LI_C_CAPNP_ALIGN
#endif
...
struct capn_segment {
	...
	uint32_t id;
	/* user settable */
	LI_C_CAPNP_ALIGN char *data;
    LI_C_CAPNP_ALIGN size_t len;
    LI_C_CAPNP_ALIGN size_t cap;
	void *user;
};

#undef LI_C_CAPNP_ALIGN
